...
<form
    ...
    <input type="hidden" name="profile" value="${question.profile!}">
                ...
                <p>
                    Pleae note that due to an incorrect interpretation of cookies within the 
                    operation system the shortlist requires additional effort to implement 
                    (a sub-domain needs to be created for the Funnelback API)
                    and the click and query history are not available.
                </p>
...
<script src="https://cdn.jsdelivr.net/npm/es6-promise@4/dist/es6-promise.auto.min.js" nomodule></script>

<!-- Shortlist functionality shipped by Funnelback -->
